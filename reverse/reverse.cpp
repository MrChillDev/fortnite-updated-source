...

{
	...
	Log3(skCrypt(" Press [ F7 ] once you are ready...\n"));
	std::cout << skCrypt("\n");
...
float Skeletonchik[3] = { color.Magenta[0], color.Magenta[1], color.Magenta[2] };
float SkeletonColor[3] = { color.Magenta[0], color.Magenta[1], color.Magenta[2] };
...
float boxchick[3] = { color.Magenta[0], color.Magenta[1], color.Magenta[2] };
float boxcolor[3] = { color.Magenta[0], color.Magenta[1], color.Magenta[2] };

float threedBoxchikl[3] = { color.Magenta[0], color.Magenta[1], color.Magenta[2] };
float threedBoxcolor[3] = { color.Magenta[0], color.Magenta[1], color.Magenta[2] };
...
float suqaredchicl[3] = { color.Magenta[0], color.Magenta[1], color.Magenta[2] };
float squarecolor[3] = { color.Magenta[0], color.Magenta[1], color.Magenta[2] };

float cornerchick[3] = { color.Magenta[0], color.Magenta[1], color.Magenta[2] };
float cornercolor[3] = { color.Magenta[0], color.Magenta[1], color.Magenta[2] };
...
void render() {
	...
	if (ShowMenu)
	{
		...
		ImGui::Begin(("nxvisia#0001 reverse remake   |  " __DATE__  __TIME__), 0, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoScrollbar);
